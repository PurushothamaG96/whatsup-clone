...
export default function AuthPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#111b21", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: "420px", margin: "0 16px" }}>
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <div style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: "80px", height: "80px", borderRadius: "50%", background: "#202c33", marginBottom: "16px" }}>
          ...
          <p style={{ fontSize: "14px", color: "#8696a0", marginTop: "4px" }}>{isLogin ? "Sign in to continue" : "Create your account"}</p>
        </div>
        <div style={{ background: "#202c33", borderRadius: "12px", padding: "32px", boxShadow: "0 20px 60px rgba(0,0,0,0.5)" }}>
          ...
          <div style={{ marginTop: "24px", textAlign: "center" }}>
            <span style={{ fontSize: "14px", color: "#8696a0" }}>{isLogin ? "Don't have an account? " : "Already have an account? "}</span>
            <button onClick={() => setIsLogin(!isLogin)} style={{ fontSize: "14px", color: "#00a884", background: "none", border: "none", cursor: "pointer", fontWeight: 500 }}>
